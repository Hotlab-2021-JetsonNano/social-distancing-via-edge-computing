...
class TrtYOLO(object):
    ...
    def detect(self, img, conf_th=0.3, letter_box=None):
        ...
        toc = time.time()
        print("C_Thread - preprocessing  : ", '{:.2f}'.format(round((toc - tic) * 1000, 2)).rjust(10), "ms") ##
        ...
        if self.cuda_ctx:
            self.cuda_ctx.pop()
        toc = time.time()
        print("C_Thread - inference      : ", '{:.2f}'.format(round((toc - tic) * 1000, 2)).rjust(10), "ms") ##
        ...
        toc = time.time()
        print("C_Thread - postprocessing : ", '{:.2f}'.format(round((toc - tic) * 1000, 2)).rjust(10), "ms") ##
